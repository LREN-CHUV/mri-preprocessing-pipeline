function DWI_pipeline_sequential(PipelineConfigFile)
...
%Subj_IDs2Compute = {'PR01335_MJ170846'};
Ns = length(Subj_IDs2Compute);  % Number of subjects ...

%% Sequentially
for i=1:Ns
    SubjID = Subj_IDs2Compute{i};
    DWI_pipeline(InputFolder,MPMDataFolder,MPRAGEFolder,OutputFolder,ProtocolsFile,SubjID);
    disp(['Finished number ' num2str(i) ' of ' num2str(Ns) ': ' SubjID])
end;
