...
pm_def.TOTAL_EPI_READOUT_TIME = 550e-3*118/2;%106 voxels with 12% oversampling along PE GRAPPA factor 2

% Defaults for Unwarping.
%=======================================================================
pm_def.DO_JACOBIAN_MODULATION = 1;    % Do jacobian modulation to adjust 
