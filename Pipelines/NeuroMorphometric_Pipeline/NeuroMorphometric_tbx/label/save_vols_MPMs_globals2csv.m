function XLS_Table = save_vols_MPMs_globals2csv(VolumeFile,AtlasFile,MPMFolder,OutputCSVFile,GM_File,WM_File,CSF_File)
...
%
%% Output Parameters:
%    XLS_Table : Excel spreadsheet with the information of the volume, and MPMs per structure plus globals measures.
%
%
%% Lester Melie-Garcia
% LREN, Lausanne
...
Table_Header = {'Structure Names','Volume(cm3)','R2* [1/ms]','Magnetization Transfer (MT)','Proton Density','R1 [1000/s]','Number of voxels','Volume/TIV'};
...
GT = [GM_total_Vol,GM_total_R2s,GM_total_MT,GM_total_PD,GM_total_R1,GM_total_Nvox,GM_total_Vol_norm
      GM_R_Vol    ,GM_R_R2s    ,GM_R_MT    ,GM_R_PD    ,GM_R_R1    ,GM_R_Nvox    ,GM_R_Vol_norm
      GM_L_Vol    ,GM_L_R2s    ,GM_L_MT    ,GM_L_PD    ,GM_L_R1    ,GM_L_Nvox    ,GM_L_Vol_norm
      WM_total_Vol,WM_total_R2s,WM_total_MT,WM_total_PD,WM_total_R1,WM_total_Nvox,WM_total_Vol_norm
      TIV         ,   0        ,   0       ,   0       ,   0       ,TIV_Nvox     ,     1            ];
...
StructNames = {StructNames = {'3rd Ventricle'
    '4th Ventricle'
