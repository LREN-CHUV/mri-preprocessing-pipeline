...
dwParams.fitMethod               = 'CNLLS';
dwParams.nStep                   = 50;
dwParams.eddyCorrect             = 1; 
dwParams.excludeVols             = []; 
dwParams.bsplineInterpFlag       = true; 
...
dwParams.FieldMapCorrect         = true;
dwParams.fitDTI                  = true;
dwParams.fitNODDI                = true;
dwParams.useAMICO                = true;
dwParams.AMICOfitmethod          = 2;
dwParams.EPI_readout_time        = '';
dwParams.Phase_Trav_BLIP_DIR     = 1; % K-space traversal blip direction +ve = 1, -ve = -1. Important for the field map unwrapping.
dwParams.mrtrixParams            = '';
dwParams.SessionNum              = '';
dwParams.RepeatNum               = '';
dwParams.SubjectID               = '';
