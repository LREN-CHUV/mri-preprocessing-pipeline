...
% % David Edit 10/02/2014 to remove structural alignment
% acpcXform = [];
...
for ii=1:nvols
    ...
    % Run field map correction on EC corrected image data
%     if doFieldmap ==1
%         im = DTI_DistCorr_withEC(dataDir,dataDir,im,EPI_readout_time);
%     end
...
%% Write out eddy/motion-corrected, structural-aligned raw data
