function [Subj_OutputFolder,SubjOutMPMFolder] = Preproc_mpm_maps(SubjectFolder,SubjID,OutputFolder,GlobalMPMFolder,ProtocolsFile,MPM_Template,ServerFolder,doUNICORT)
