function itwasprocessed = fMRI_preprocessing(SubjSessionFolder,Mode,volnum,dummyscans,grefieldSequenceName,StructSequenceName,EPISequenceName,pmDefaultFilePath,TPMs)
% function needed:
% getAllFiles
...
TPMpaths = {strcat(p, filesep, ['tpm',filesep,TPMs,',1']);strcat(p, filesep, ['tpm',filesep,TPMs,',2']);strcat(p, filesep, ['tpm',filesep,TPMs,',3']);strcat(p, filesep, ['tpm',filesep,TPMs,',4']);strcat(p, filesep, ['tpm',filesep,TPMs,',5']);strcat(p, filesep, ['tpm',filesep,TPMs,',6'])};
