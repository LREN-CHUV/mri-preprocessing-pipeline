function [ D, eigVal, eigVec ] = CNLLS_FitTensor( s, bMATRIX, maxiter )

warning('off','all')

% Find zero value datapoints to exclude
Inds = find(s);
s = s(Inds);
...
% estimation
[CNLLS_pvec,CostFunRecord, costfun_change]=MFN_CNLLS_tensor_estimate(W,p,s,1,maxiter);
