function unwarpedname=DTI_DistCorr(fm_dir,anat_dir,DWIfilename,EPI_readout_time, phase_blip_dir, comment)
...
pm_def = pm_defaults_diffusion(EPI_readout_time,phase_blip_dir);
