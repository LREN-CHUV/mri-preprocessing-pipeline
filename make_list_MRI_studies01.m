function Subj_IDs = make_list_MRI_studies01(ServerDataFolder,OutputXLSFile)
...
ind = ismember(Subjs(:,1),{'deleteit';'140318~1.660';'140502~1.660';'exv_post-fix-im';'exv_post-fix-im2';'H2O'; 'ACSFcool';'ACSFwarm';'ACSFwarm-h';'PBS';'exv_post-fix-del'; ...
