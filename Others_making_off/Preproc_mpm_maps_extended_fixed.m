function [Subj_OutputFolder,SubjOutMPMFolder] = Preproc_mpm_maps_extended_fixed(SubjectFolder,SubjID,OutputFolder,GlobalMPMFolder,ProtocolsFile,MPM_Template,ServerFolder,doUNICORT)

%% Anne Ruef, Lester Melie-Garcia
% LREN, CHUV. 
% Lausanne, May 21st, 2014
% Modified: October 2nd, 2014
...
for i=1:Ns_t
    Nprot_t(i) = get_valid_MPM_Protocols(ProtocolsFile,[SubjectFolder,RawSession_Folders{i},filesep]); % Number of protocols
end;
...
if sum(Nprot_t)>0    
    ...
    for i=1:Ns
        ...
        [Nprot,B0_p,B1_p,MT_p,PD_p,T1_p] = get_valid_MPM_Protocols(ProtocolsFile,DataFolder); % Valid Protocols and Number of protocols
