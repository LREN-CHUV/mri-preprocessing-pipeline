function Subj_IDs = make_list_MRI_studies_NODDI_MB2_2pt2mm(ServerDataFolder,OutputXLSFile)
...
r = 1; % Subjects with 1mm MPM protocol counter
DateFolders = getListofFolders(ServerDataFolder);
ZZZ = {'ep2d_diff_NODDI_MB2_2pt2mm'};
