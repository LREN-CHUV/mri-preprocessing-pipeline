function Preproc_mpm_maps_extended_parallel_renaud(PipelineConfigFile)
...
if ~exist('PipelineConfigFile','var')
    PipelineConfigFile = which('Preproc_mpm_maps_pipeline_config_renaud.txt');
...
% BlackList = {'PR00459_GA050675'}; % {'PR00125'};
