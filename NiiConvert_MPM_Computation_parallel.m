function NiiConvert_MPM_Computation_parallel(PipelineConfigFile,NiFti_OutputFolder)
...
%NiiConvert_MPM_Computation(SubjectFolder,SubjID,NiFti_OutputFolder,ProtocolsFile,OutputFolder,GlobalMPMFolder,MPM_Template,ServerFolder,doUNICORT)
...
for i=1:Ns
    ...
    InputParametersF = horzcat({SubjectFolder},{SubjID},{NiFti_OutputFolder},{NiFti_Server_OutputFolder},{ProtocolsFile},{MPM_OutputFolder}, ...
                               {GlobalMPMFolder},{MPM_Template},{ServerFolder},{doUNICORT}); %#ok
    NameField = 'Name'; %#ok
