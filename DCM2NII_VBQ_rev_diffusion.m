function Subj_OutputFolder = DCM2NII_VBQ_rev_diffusion(SubjectFolder,SubjID,OutputFolder,ProtocolsFile)
...
for j=1:Ns
    ...
    FolderNames = {'ep2d_diff_NODDI_MB2_2pt2mm'};
    if ~isempty(FolderNames)
        for i=1:length(FolderNames)            
            which_prot = which_protocol(FolderNames{i},diffusion_protocol,MT_protocol,PD_protocol,T1_protocol);
