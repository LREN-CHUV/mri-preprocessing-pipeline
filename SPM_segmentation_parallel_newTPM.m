function SPM_segmentation_parallel_newTPM(SubjectList,ServerFolder,TemplateImage,WhichImage)
...
PipelineFunction = 'SPM_segmentation_pipeline_newTPM';  %  SPM_segmentation_pipeline_newTPM(ServerFolder,SubjectID,TemplateImage,WhichImage)
for i=1:Ns
